 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Zend_Service_Facebook_Client extends Zend_Http_Client {
     ...
     * @return object
     */
    abstract public function callRestMethod($method, $args = array(), $response_format=Zend_Service_Facebook::RESPONSE_JSON);
     ...
     * @return object
     */
    abstract public function makeRequest($url, $args = array(), $http_method=Zend_Http_Client::GET, $response_format=Zend_Service_Facebook::RESPONSE_JSON);
     ...
     */
    protected function parseResponse(Zend_Http_Response $response, $response_format = Zend_Service_Facebook::RESPONSE_JSON) {
        $result = null;
