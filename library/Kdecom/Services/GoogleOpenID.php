<?php
  ...
  ****************************************************************************/
  ...
  class Kdecom_Services_GoogleOpenID{
    ...
    private function GoogleOpenID($mode, $op_endpoint, $response_nonce, $return_to, $realm, $assoc_handle, $claimed_id, $signed, $sig, $email, $require_email){
      ...
      if(is_null($assoc_handle))
        $assoc_handle = Kdecom_Services_GoogleOpenID::getAssociationHandle();
    ...
    public static function createRequest($return_to, $assoc_handle=null, $require_email=false){
      return new Kdecom_Services_GoogleOpenID("checkid_setup", null, null, $return_to, null, $assoc_handle, "http://specs.openid.net/auth/2.0/identifier_select", null, null, null, $require_email);
    }//createRequest
    ...
    public static function create($params){
      ...
      return new Kdecom_Services_GoogleOpenID($mode, $op_endpoint, $response_nonce, $return_to, $realm, $assoc_handle, $claimed_id, $signed, $sig, $email, $require_email);
    }//create

    //creates and returns a GoogleOpenID from the $_GET variable
    public static function getResponse(){
      return Kdecom_Services_GoogleOpenID::create($_GET);
    }//getResponse
    ...
    public static function getAssociationHandle($endpoint=null){
      ...
      if(is_null($endpoint))
        ...
        $request_url = Kdecom_Services_GoogleOpenID::getEndPoint();
    ...
    public static function getEndPoint(){
      ...
      $request_url = Kdecom_Services_GoogleOpenID::google_discover_url;
      ...
      echo $uri = $uri->item(0)->nodeValue;die;
    ...
    public function getArray(){
      ...
      $ret['openid.ns'] = Kdecom_Services_GoogleOpenID::openid_ns;
      ...
      if(($this->mode=="checkid_setup" AND $this->require_email) OR
        ...
        $ret['openid.ns.ext1'] = Kdecom_Services_GoogleOpenID::openid_ns_ext1;
        $ret['openid.ext1.mode'] = Kdecom_Services_GoogleOpenID::openid_ext1_mode;
        $ret['openid.ext1.type.email'] = Kdecom_Services_GoogleOpenID::openid_ext1_type_email;
        $ret['openid.ext1.required'] = Kdecom_Services_GoogleOpenID::openid_ext1_required;
    ...
    public function endPoint(){
      ...
      $endpoint = Kdecom_Services_GoogleOpenID::getEndPoint();
